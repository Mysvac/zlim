...
/// An isometry in two dimensions, representing a rotation followed
/// by a translation.
///
/// This can often be useful for expressing relative positions and
/// transformations from one position to another.
///
/// In particular, this type represents a distance-preserving
/// transformation known as a *rigid motion* or a *direct motion*,
/// and belongs to the special [Euclidean group] SE(2). This
/// includes translation and rotation, but excludes reflection.
///
...
///
/// ```
/// # use zlim_math::{Isometry2d, Rot2, Vec2};
/// #
...
/// ```
///
/// One common operation is to compute an isometry representing the
/// relative positions of two objects for things like intersection
/// tests. This can be done with an inverse transformation:
///
/// ```
/// # use zlim_math::{Isometry2d, Rot2, Vec2};
/// #
...
impl approx::AbsDiffEq for Isometry2d {
...
#[cfg(any(feature = "approx", test))]
impl approx::RelativeEq for Isometry2d {
    fn default_max_relative() -> Self::Epsilon {
        <Self as approx::AbsDiffEq>::default_epsilon()
    }
...
#[cfg(any(feature = "approx", test))]
impl approx::UlpsEq for Isometry2d {
...
///
/// ```
/// # use zlim_math::{Isometry3d, Quat, Vec3};
...
#[cfg(any(feature = "approx", test))]
impl approx::AbsDiffEq for Isometry3d {
    type Epsilon = <f32 as approx::AbsDiffEq>::Epsilon;
...
#[cfg(any(feature = "approx", test))]
impl approx::RelativeEq for Isometry3d {
    fn default_max_relative() -> Self::Epsilon {
        <Self as approx::AbsDiffEq>::default_epsilon()
    }
...
#[cfg(any(feature = "approx", test))]
impl approx::UlpsEq for Isometry3d {
    fn default_max_ulps() -> u32 {
        4
    }
