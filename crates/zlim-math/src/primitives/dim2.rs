...
use crate::measure::Measured2d;
use crate::ops::{self, FloatPow};
use crate::primitives::Inset;
use crate::{Dir2, InvalidDirectionError, Isometry2d};
use crate::{Primitive2d, Ray2d, Rot2, Vec2};
...
impl Arc2d {
    ...
    ///
    /// The sagitta is also the difference of the [`radius`](Self::radius) and the [`apothem`](Self::apothem).
...
///
/// **Warning:** Circular sectors with negative angle or radius, or with angle greater than
...
///
/// **Warning:** Circular segments with negative angle or radius, or with angle greater than
...
impl Display for ConvexPolygonError {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::Concave => f.write_str("The created polygon is not convex"),
        }
    }
}

impl core::error::Error for ConvexPolygonError {}
