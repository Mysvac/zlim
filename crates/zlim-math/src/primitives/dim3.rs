...
use crate::{Dir3, InvalidDirectionError, Isometry3d, Mat3};
use crate::{Primitive2d, Primitive3d, Quat, Ray3d, Vec2, Vec3};
...
impl InfinitePlane3d {
    ...
    ///
    /// ```
    /// # use zlim_math::{Vec3, Dir3};
    /// # use zlim_math::primitives::InfinitePlane3d;
    ///
