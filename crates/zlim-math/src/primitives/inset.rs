...
use crate::primitives::{
    Capsule2d, Circle, CircularSegment, Rectangle, RegularPolygon, Rhombus, Triangle2d,
};
use crate::{Primitive2d, Vec2};
...
pub trait Inset: Primitive2d {
    ...
    ///
    /// This is useful for creating smaller shapes or making outlines of `distance` thickness.
