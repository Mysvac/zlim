...
/// This extension trait covers shortfall in determinacy from the lack
/// of a `libm` counterpart to `f32::powi`.
///
...
#[expect(
    ...
    reason = "Many of the disallowed methods are disallowed to force \
    code to use the feature-conditional re-exports from this module, \
    but this module itself is exempt from that rule."
)]
mod std_ops {
