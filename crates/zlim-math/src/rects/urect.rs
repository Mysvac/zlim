...
mod tests {
    ...
    #[test]
    fn rect_conversions() {
        let r = URect::new(1, 2, 5, 3);
        let f = r.as_rect();
        assert_eq!(f.min, crate::Vec2::new(1., 2.));
        assert_eq!(f.max, crate::Vec2::new(5., 3.));
        let i = r.as_irect();
        assert_eq!(i.min, crate::IVec2::new(1, 2));
        assert_eq!(i.max, crate::IVec2::new(5, 3));
    }
}
