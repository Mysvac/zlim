...
use crate::primitives::{Line2d, Polygon, Polyline2d, Rectangle};
use crate::primitives::{RegularPolygon, Ring, Segment2d, Triangle2d};
use crate::{Isometry2d, Isometry3d, Primitive2d, Quat, Rot2, ops};
...
mod tests {
    ...
    use crate::{EulerRot, Quat, Vec2, Vec3, Vec3A};
