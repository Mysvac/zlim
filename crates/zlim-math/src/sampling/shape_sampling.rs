...
//! ```
//! # use zlim_math::primitives::*;
//! # use zlim_math::ShapeSample;
...
//! ```
//! # use zlim_math::primitives::*;
//! # use zlim_math::{Vec2, ShapeSample};
//! # use rand::SeedableRng;
//! # use rand::rngs::StdRng;
...
use crate::{Measured2d, Measured3d, NormedVectorSpace, Primitive2d, ScalarField, Vec2, Vec3, ops};
