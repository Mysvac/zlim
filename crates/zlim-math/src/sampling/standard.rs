...
//! allow certain zlim math types (those whose values can be randomly generated without additional
...
//! # use zlim_math::{Dir3, sampling::FromRng};
...
use crate::ops;
use crate::{Dir2, Dir3, Dir3A, Quat, Rot2, Vec2, Vec3};
