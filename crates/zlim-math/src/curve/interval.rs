...
impl Display for InvalidIntervalError {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        f.write_str("The resulting interval would be invalid (empty or with a NaN endpoint)")
    }
}
...
impl Display for SpacedPointsError {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        f.write_str("Cannot extract spaced points from an unbounded interval")
    }
}
...
impl Display for LinearMapError {
    fn fmt(&self, f: &mut Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::SourceUnbounded => f.write_str("The source interval is unbounded"),
            Self::TargetUnbounded => f.write_str("The target interval is unbounded"),
        }
    }
}

impl core::error::Error for LinearMapError {}
