//! Contains [`Bounded2d`] implementations for [geometric primitives](crate::dim2).

use core::f32::consts::{FRAC_PI_2, PI, TAU};

use zlim_math::{Dir2, Isometry2d, Mat2, Rot2, Vec2, ops};

use super::{Aabb2d, Bounded2d, BoundingCircle};
use crate::bounding::BoundingVolume;
use crate::{Annulus, Arc2d, Capsule2d, Circle, CircularSector};
use crate::{CircularSegment, Primitive2d, Segment2d, Triangle2d};
use crate::{ConvexPolygon, Ellipse, Line2d, Plane2d, Polygon, Polyline2d};
use crate::{Rectangle, RegularPolygon, Rhombus, Ring};
...
#[inline]
fn arc_bounding_points(arc: Arc2d, rotation: impl Into<Rot2>) -> Vec<Vec2> {
...
mod tests {
    ...
    use zlim_math::{Dir2, Isometry2d, Rot2, Vec2};
