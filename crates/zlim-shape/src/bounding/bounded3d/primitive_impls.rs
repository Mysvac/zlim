//! Contains [`Bounded3d`] implementations for [geometric primitives](crate::dim3).

use zlim_math::{Isometry2d, Isometry3d, Mat3, Vec2, Vec3, Vec3A, ops};

use super::{Aabb3d, Bounded3d, BoundingSphere};
use crate::bounding::{Bounded2d, BoundingCircle, BoundingVolume};
use crate::{Capsule3d, Cone, ConicalFrustum, Cylinder};
use crate::{Cuboid, InfinitePlane3d, Line3d, Polyline3d};
use crate::{Segment3d, Sphere, Torus, Triangle2d, Triangle3d};
