...
use zlim_math::{Isometry2d, Isometry3d, Quat, Rot2, ops};
use zlim_math::{Vec2, Vec3A, Vec3Swizzles};

use super::{Aabb3d, Bounded3d, BoundingSphere};
use crate::{Capsule2d, Circle, Cuboid, Cylinder, Ellipse, Extrusion};
use crate::{Line2d, Polygon, Polyline2d, Primitive2d, Rectangle};
use crate::{RegularPolygon, Ring, Segment2d, Triangle2d};
...
mod tests {
    ...
    use zlim_math::{Dir2, Isometry3d, ops};
    use zlim_math::{EulerRot, Quat, Vec2, Vec3, Vec3A};
