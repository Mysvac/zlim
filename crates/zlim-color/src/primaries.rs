...
/// A position in the [CIE 1931 xy chromaticity diagram],
...
impl Chromaticity {
    ...
    /// The [CIE Standard Illuminant D65] white point, as specified by ITU-R BT.709 / BT.2020 and the sRGB standard.
    ///
    /// [CIE Standard Illuminant D65]: https://registry.color.org/rgb-registry/srgb#:~:text=White%20point%20chromaticity
    pub const D65: Self = Self::new(0.3127, 0.3290);

    /// The [ACES white point], about CIE Standard Illuminant D60.
    ///
    /// [ACES white point]: https://docs.acescentral.com/white-point/
...
impl RgbPrimaries {
    /// The [ITU-R BT.709] primaries with a D65 white point.
    ///
    /// sRGB and [`LinearRgba`](crate::LinearRgba) use these primaries.
    ///
    /// [ITU-R BT.709]: https://registry.color.org/rgb-registry/bt709
    ...
    /// The [ITU-R BT.2020] (Rec. 2020) wide-gamut primaries with a D65 white point.
    ///
    /// [ITU-R BT.2020]: https://registry.color.org/rgb-registry/bt2020
    ...
    /// The [Display P3] primaries: the DCI-P3 primaries with a D65 white point.
    ///
    /// [Display P3]: https://registry.color.org/rgb-registry/displayp3
    ...
    /// The [ACEScg] (AP1) primaries with the ACES white point, used for scene-linear rendering.
    ///
...
mod tests {
    use super::*;
    use crate::tests::{assert_approx_eq, assert_mat3_approx_eq};
    use zlim_math::Vec3;
